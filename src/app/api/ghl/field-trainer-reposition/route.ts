...
export async function POST(req: Request) {
  try {
    ...
    const parsed = fieldTrainerRepositionSchema.safeParse(body);
    if (!parsed.success) {
      return NextResponse.json(
    ...
    const payload = buildFieldTrainerRepositionPayload(
      parsed.data,
    ...
    console.error("Unexpected error in field-trainer-reposition proxy:", error);
    return NextResponse.json(
