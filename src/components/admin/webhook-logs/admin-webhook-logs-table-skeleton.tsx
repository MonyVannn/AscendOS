...
export function AdminWebhookLogsTableSkeleton() {
  return (
      ...
      <Table>
        <TableHeader>
          <TableRow className="border-b border-border hover:bg-transparent">
            ...
            <TableHead className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider h-10">Agency</TableHead>
            ...
            <TableHead className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider h-10">Submitted by</TableHead>
