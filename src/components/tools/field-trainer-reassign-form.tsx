      ...
      <div className="p-6 md:p-8 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Who are you reassigning a trainer for?</p>
          </div>
        </div>
            ...
            <div className="flex gap-3 p-4 rounded-xl bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 text-amber-900 dark:text-amber-400">
              ...
              <div className="text-sm space-y-1">
                ...
                <div className="text-amber-700 dark:text-amber-400/80">
                  Some fields are missing, but this isn&apos;t required for reassigning a trainer. You can <Link href="/dashboard/settings/profile" className="font-semibold underline decoration-amber-400 dark:decoration-amber-600 underline-offset-4 hover:text-amber-900 dark:hover:text-amber-200">update your Settings</Link> if you&apos;d like.
                </div>
              </div>
            </div>
          )}
